...
(defun glf-search-end-of-header ()
  (save-excursion
    (goto-char (point-min))
    (if (search-forward "HEADER_END" nil t)
        (forward-char)
      (message "Broken GLF file: header not found"))
    (point) ))

(defun glf-get-header-definitions ()
  ;; do not parse the header, just set the values
  (let ((cols
         "Location|Guid|Time|Tzone|Trace|Log|Importance|Severity|Exception|DeviceName|ProcessID|ThreadID|ThreadName|ScopeTag|MajorTick|MinorTick|MajorDepth|MinorDepth|RootName|RootID|CallerName|CallerID|CalleeName|CalleeID|ActionID|DSRRootContextID|DSRTransaction|DSRConnection|DSRCounter|User|ArchitectComponent|DeveloperComponent|Administrator|Unit|CSNComponent|Text"))

    (set (make-local-variable 'glf-end-of-header-point) (glf-search-end-of-header))
    (set (make-local-variable 'glf-record-separator) 30)
    (set (make-local-variable 'glf-column-separator) 124)
    (set (make-local-variable 'glf-escape-char) 27)
